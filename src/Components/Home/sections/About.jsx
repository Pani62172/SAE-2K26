...
const About = () => {
  ...
  return (
    <>
      ...
      <div ref={aboutRef} className='h-auto lg:h-screen bg-white rounded-tl-[20px] rounded-tr-[20px] relative z-10 pb-10 lg:pb-0 pt-6 lg:pt-0'>
        <div className=' text-4xl md:text-3xl xl:text-[30px] 2xl:text-5xl text-black items-center justify-center flex flex-col uppercase font-heading font-semibold hover:text-red-500 border-[1px] border-b-black border-transparent justifyBetween'>About SAE</div>
          ...
          <div className='about-text main-container py-4 lg:py-12 flex justify-center items-start lg:items-center mt-6 lg:mt-0 font-heading text-black text-xl md:text-3xl xl:text-[45px] 2xl:text-5xl leading-[1.25] lg:leading-[1.3]'>
