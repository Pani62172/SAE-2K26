...
function Aarohan() {
  ...
  useEffect(() => {
    ...
    if (heroCarouselElement) {
      bootstrapCarouselInstance = new Carousel(heroCarouselElement, {
        interval: 4000,
        ride: "carousel",
        pause: false,
      });
  ...
  // Build event cards — hover is handled entirely by CSS, no JS tilt
      ...
      <div key={event.id} className="carousel-item-wrapper">
        <div className="arhn-card">
          ...
          <div className="arhn-card-content">
            <h2 className="absolute top-6 w-full px-4 z-20 text-2xl lg:text-3xl font-bold text-white text-center drop-shadow-xl break-words leading-tight">
              {event.name}
            </h2>
    ...
    <>
        ...
        >
          <div className="carousel-inner">
            ...
            <div className="carousel-item">
              <img
                src="./6617e9667ea53b0c8bd3b345.jpg"
                className="d-block w-100"
                alt="Hero 2"
              />
            </div>
        ...
        <main className="parallax-main">
            ...
            <article className="parallax-content">
              <h1
                ...
                style={{
                  ...
                  marginBottom: "1rem",
                  backgroundImage:
                    "linear-gradient(to bottom, rgb(255, 46, 46), rgb(114, 5, 5))",
              ...
              <p className="text-lg text-gray-300 leading-relaxed text-center">
                Aarohan is not just a fest; it is a legacy. As the
                second-largest techno-management fest in Eastern India, hosted
                by Team Aavishkar at NIT Durgapur, we have been curating the
                future for over 50 years. It is the convergence of code,
          ...
          <section className="parallax-section">
            ...
            <article className="parallax-content">
              ...
              <p className="text-lg text-gray-300 leading-relaxed text-center">
                The SAE India Collegiate Club of NIT Durgapur powers the
                mechanical heart of Aarohan. From the roar of engines in Car
                Auction to the precision of Flying UAVs, SAE brings engineering
                to life, transforming theoretical concepts into
                adrenaline-fueled reality.
              </p>
            </article>
          </section>
        </main>
      ...
      <div className="px-6 lg:px-32 py-20">
        <div className="mb-16 text-center" data-aos="fade-up">
          <h1 className="thearena">The Arena</h1>
          <p className="text-gray-500 mt-4 tracking-widest uppercase text-lg">
      ...
      <div className="px-6 lg:px-32 py-20">
        <div className="mb-16 text-center" data-aos="fade-up">
          <h1 className="thearena">AAROHAN GALLERY</h1>
        </div>
          ...
          <div className="arhn-slider">
            <div className="arhn-slide-track">
              {[...arhn_gallary, ...arhn_gallary].map((arhn_img, idx) => (
                <div
                  key={`mobile-gal-${idx}`}
                  className="arhn-single-slide w-[300px] h-[200px] mx-4"
                >
                  <img
                    src={arhn_img.posters}
                    alt="gallery"
